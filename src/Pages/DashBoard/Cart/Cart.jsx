        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 gap-4 justify-items-center items-center pb-4 text-2xl cinzel-bold">
          ...
          {cart.length ? (
            <Link to="/dashboard/payment">
              <button className="btn bg-[#D1A054] border-[#D1A054] text-white hover:bg-[#bb8c46] hover:border-[#D1A054]">
                pay
              </button>
            </Link>
          ) : (
            <button
              className="btn bg-[#D1A054] border-[#D1A054] text-white hover:bg-[#bb8c46] hover:border-[#D1A054]"
              disabled
            >
              pay
            </button>
